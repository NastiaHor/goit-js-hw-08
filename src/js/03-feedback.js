...
const formSubmitHandleEmailInput = () => { 
  throttledSaveToLocalStorage(formRefs); 
}; 
 
const formSubmitHandleMessageInput = () => { 
  throttledSaveToLocalStorage(formRefs); 
}; 
 
formRefs.emailInputEl.addEventListener('input', formSubmitHandleEmailInput); 
 
formRefs.messageInputEl.addEventListener('input', formSubmitHandleMessageInput);
